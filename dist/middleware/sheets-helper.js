...
function getEmails(req, res, next) {
  ...
  if (notification) {
    var _infoSheet = info.worksheets[INFO_SHEET_INDEX];
    getSheetRows(_infoSheet).then(function (rows) {
